	...
	<div class="h_left">
		...
		<div class="tmn">
			...
			<ul class="list">
				...
				<li>
					<a href="buyList.jsp" class="${pageNumDepth01 == 5 ? 'on' : ''}">구매처 관리<span>3<%--${itmSupplierCount}--%></span></a>
				</li>
				<li>
					<a href="locList.jsp" class="${pageNumDepth01 == 6 ? 'on' : ''}">위치 관리<span>5<%--${itmLocationCount}--%></span></a>
				</li>
				<li>
					<a href="assetCategory.jsp" class="${pageNumDepth01 == 11 ? 'on' : ''}">자산 분류 관리<span>4<%--${itmAssetCategoryCount}--%></span></a>
				</li>
				<li>
					<a href="aStatList.jsp" class="${pageNumDepth01 == 7 ? 'on' : ''}">자산 상태 관리<span>7<%--${itmStateCount}--%></span></a>
				</li>
				<li>
					<a href="eStatList.jsp" class="${pageNumDepth01 == 8 ? 'on' : ''}">직원 상태 관리<span>3<%--${itmEmpStateCount}--%></span></a>
				</li>
				<li>
