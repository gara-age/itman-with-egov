...
<body>
	...
	<div id="popup">
		...
		<div class="pop_cont">
            <form method="post" id="form" action="pp_process/emploNumInfoEdit_proc.jsp">
                <input type="hidden" name="emp_idx" value="<?=$EMP_IDX?>">
			<ul class="contEdit">
				<li>
					<p class="tit">직원 사번</p> <!-- 자산명, 최초 구매일, 가격(원) 등 인풋폼-->
					<p class="cont"><input type="text" name="emp_num" value="<?=$result['EMP_NUM']?>"  placeholder="변경할 사번을 입력하세요."></p>
				</li>
				<!-- 비고란 -->				
			</ul>
            </form>
