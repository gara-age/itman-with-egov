...
<body>
	...
	<div id="popup">
		...
		<div class="pop_cont">
			<form method="post" id="itmLocationForm" action="pp_process/writeItmLocation_proc.jsp">
			<ul class="contEdit">
				<li>
					<p class="tit">자산 위치명<span>*</span></p>
					<p class="cont"><input type="text" id="loc_name" name="loc_name" placeholder="위치명을 입력해주세요." value=""></p>
				</li>
				<li>
					<p class="tit">자산 위치 코드번호<span>*</span></p>
					<p class="cont"><input type="text" id="loc_code" name="loc_code" placeholder="위치 코드 번호를 입력해 주세요. ex)000"></p>
				</li>
