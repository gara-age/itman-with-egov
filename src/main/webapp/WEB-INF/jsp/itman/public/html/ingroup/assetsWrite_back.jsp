...
<body>
	...
	<div id="contents">
		...
		<ul class="adminView Write">
			<li>
				...
				<input type="text" id="ULID" name="ULID" value="" placeholder="0000-0000-0000">
			</li>
			<li>
				<p class="tit">자산이미지</p>
			...
			<li>
				<p class="tit">사용직원</p>
				<input style="display:none" id = "emp_idx" name="emp_idx" value="" />
	...
	<script>
		...
		$ulid_cat = $("#ass_cat option:eq(0)").attr("name");
		$ulid_loc = "0000";
		$ulid_num = "0001";
		...
		$(document).ready(function(){
			...
			$("#ULID").val($ulid_cat+"-"+$ulid_loc+"-"+$ulid_num);
			...
			$('#ass_cat').on('change', function () {
				$ulid_loc = $.trim($ulid_loc);
				$.ajax({
					url: "./ig_process/assetsChangeBy.php",
					data : {which : 'cate' ,
