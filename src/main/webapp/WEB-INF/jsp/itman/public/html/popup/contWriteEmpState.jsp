...
<?php
	...
	// 기존 값 불러오기
	$idx = $_GET['idx'];
	$sql = "SELECT * FROM ITM_EMP_STATE WHERE EMP_ST_IDX = $idx";
...
<body>
	<div id="popup">
		...
		<div class="pop_cont">
			<form method="post" id="itmEmpStatForm" action="pp_process/updateEmpStat_proc.jsp">
			<input type="hidden" name="emp_st_idx" value="<?= $valueRow['EMP_ST_IDX']; ?>" >
			<ul class="contEdit">
				<li>
					<p class="tit">직원 상태명<span>*</span></p>
					<p class="cont"><input type="text" id="emp_st_name" name="emp_st_name" placeholder="직원 상태명을 입력해주세요." value="<?= $valueRow['EMP_ST_NAME']; ?>"></p>
				</li>
				<li>
					<p class="tit">상태코드번호<span>*</span></p>
					<p class="cont"><input type="text" id="emp_st_code" name="emp_st_code" placeholder="직원 상태 코드 번호를 입력해 주세요. ex)000" value="<?= $valueRow['EMP_ST_CODE']; ?>"></p>
				</li>
