...
<body>
	...
	<div id="popup">
		...
		<div class="pop_cont">
			<ul class="contEdit">
				<li>
				<form action="./supplierPop.php" id="frm" method="post" > 
					<p class="cont">
...
<!-- 				<li class="nocont">검색결과가 없습니다.</li> -->
			...
			<p class="paging">
				<a href="supplierPop.php?page=1" class="first"><img src="../../../../../../images/_img/first.png"></a>
				<a href="<?=(!$_GET['page']||$_GET['page']==1)?"supplierPop.php?page=1":"supplierPop.php?page=".$i?>" class="prev"><img src="../../../../../../images/_img/prev.png"></a>
				<?php
					for($i = 1; $i <= $total_page ; $i++){
				?>
				<a href="supplierPop.php?page=<?=$i?>" class=<?=$i==$_GET['page']||empty($_GET['page'])&& $i ==1?"on":""?>><?=$i;?></a>
				<?php }; ?>
				<a href="<?=$_GET['page']>=$total_page?"supplierPop.php?page=".$total_page:"supplierPop.php?page=".($_GET['page']+1)?>" class="next"><img src="../../../../../../images/_img/next.png"></a>
				<a href="<?="supplierPop.php?page=".$total_page?>" class="last"><img src="../../../../../../images/_img/last.png"></a>
			</p>
