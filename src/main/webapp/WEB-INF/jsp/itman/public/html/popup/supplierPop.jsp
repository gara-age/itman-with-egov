...
<body>
	...
	<div id="popup">
		...
		<div class="pop_cont">
			<ul class="contEdit">
				<li>
				<form action="${pageContext.request.contextPath}/popup/supplierPop.do" id="searchForm" method="post"onsubmit="this.page.value=1; this.range.value=1;" >
...
//처음 버튼 이벤트
function fn_maxPrev() {
	var url = "${pageContext.request.contextPath}/popup/supplierPop.do";
	url = url + "?page=" + 1;
	url = url + "&range=" + 1;
	location.href = url;	}
//이전 버튼 이벤트
