...
<body>
	...
	<div id="popup">
		...
		<div class="pop_cont">
            <form method="post" id="form" action="/itman/updateEmploMailInfo.do">
                <input type="hidden" name="empIdx" value="${employee.empIdx}">
			<ul class="contEdit">
				<li>
					<p class="tit">직원 이메일</p> <!-- 자산명, 최초 구매일, 가격(원) 등 인풋폼-->
					<p class="cont"><input type="text" name="empMail" value="${employee.empMail}"  placeholder="변경할 이메일을 입력하세요."></p>
				</li>
				<!-- 비고란 -->
			</ul>
            </form>
